...
(   
  __xdata uint8  *deviceAddr,                   //!< address of device to pair with, and could be either public or random.
 ...
 */
extern bStatus_t GAPBondMgr_SetParameter( uint16 param, uint8 len, __xdata void *pValue );
 ...
 * @return      SUCCESS or INVALIDPARAMETER (invalid paramID)
 */
extern bStatus_t GAPBondMgr_GetParameter( uint16 param, __xdata void *pValue );
 ...
 */
extern bStatus_t GAPBondMgr_LinkEst( uint8 addrType, __xdata uint8 *pDevAddr, uint16 connHandle, uint8 role ); 
 ...
 */
extern uint8 GAPBondMgr_ResolveAddr( uint8 addrType, __xdata uint8 *pDevAddr, __xdata uint8 *pResolvedAddr );
 ...
 * @return      none
 */
extern void GAPBondMgr_Register( __xdata gapBondCBs_t *pCB );
 ...
 * @return      none
 */
extern void GAPBondMgr_ProcessGAPMsg( __xdata gapEventHdr_t *pMsg );
