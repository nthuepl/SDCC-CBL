...
typedef __code bStatus_t (*pfnGATTReadAttrCB_t)( uint16 connHandle,
		__xdata gattAttribute_t *pAttr,
		__xdata uint8 *pValue,
		__xdata uint8 *pLen,
		uint16 offset,
		uint8 maxLen );
 ...
 *          Error, otherwise: ref ATT_ERR_CODE_DEFINES.<BR>
 */
typedef bStatus_t (*pfnGATTWriteAttrCB_t)( uint16 connHandle, __xdata gattAttribute_t *pAttr,
 ...
 */
extern bStatus_t GATTServApp_RegisterService( __xdata gattAttribute_t *pAttrs, uint16 numAttrs,
 ...
 */
extern __xdata gattAttribute_t *GATTServApp_FindAttr( __xdata gattAttribute_t *pAttrTbl,
                                              uint16 numAttrs, __xdata uint8 *pValue );
/**
 ...
 */
extern bStatus_t GATTServApp_SetParameter( uint8 param, uint8 len, __xdata void *pValue );
 ...
 *          INVALIDPARAMETER: Invalid parameter
 */
extern bStatus_t GATTServApp_GetParameter( uint8 param, __xdata void *pValue );
 ...
 * @return  none
 */
extern void GATTServApp_InitCharCfg( uint16 connHandle, __xdata gattCharCfg_t *charCfgTbl );
 ...
 */
extern uint16 GATTServApp_ReadCharCfg( uint16 connHandle, __xdata gattCharCfg_t *charCfgTbl );
 ...
 */
extern uint8 GATTServApp_WriteCharCfg( uint16 connHandle, __xdata gattCharCfg_t *charCfgTbl, uint16 value );
 ...
 * @return  Success or Failure
 */
extern bStatus_t GATTServApp_ProcessCCCWriteReq( uint16 connHandle, __xdata gattAttribute_t *pAttr,
                                          __xdata uint8 *pValue, uint8 len, uint16 offset,
                                          uint16 validCfg );
 ...
 * @return  Success or Failure
 */
extern bStatus_t GATTServApp_ProcessCharCfg( __xdata gattCharCfg_t *charCfgTbl, __xdata uint8 *pValue,
                                        uint8 authenticated, __xdata gattAttribute_t *attrTbl,
 ...
 * @return      Success or Failure
 */
extern uint8 GATTServApp_ReadAttr( uint16 connHandle, __xdata gattAttribute_t *pAttr,
                                   uint16 service, __xdata uint8 *pValue, __xdata uint8 *pLen,
...
extern uint8 GATTServApp_WriteAttr( uint16 connHandle, uint16 handle,
                                    __xdata uint8 *pValue, uint16 len, uint16 offset );
