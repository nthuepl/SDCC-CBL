...
; This file was generated Tue Jun 03 20:48:49 2014
;--------------------------------------------------------
	.module CodeGeneratorMain
...
;------------------------------------------------------------
;	../CodeGeneratorMain.c:68: void Main()
;	-----------------------------------------
;	 function Main
;	-----------------------------------------
_Main:
	...
	ar1 = 0x01
	ar0 = 0x00
;	../CodeGeneratorMain.c:71: attDeviceName[0] ='E';
	mov	dptr,#_attDeviceName
	mov	a,#0x45
	movx	@dptr,a
;	../CodeGeneratorMain.c:72: attDeviceName[1] ='c';
	mov	dptr,#(_attDeviceName + 0x0001)
	mov	a,#0x63
	movx	@dptr,a
;	../CodeGeneratorMain.c:73: attDeviceName[2] ='o';
	mov	dptr,#(_attDeviceName + 0x0002)
	mov	a,#0x6F
	movx	@dptr,a
;	../CodeGeneratorMain.c:74: attDeviceName[3] ='G';
	mov	dptr,#(_attDeviceName + 0x0003)
	mov	a,#0x47
	movx	@dptr,a
;	../CodeGeneratorMain.c:75: attDeviceName[4] ='e';
	mov	dptr,#(_attDeviceName + 0x0004)
	mov	a,#0x65
	movx	@dptr,a
;	../CodeGeneratorMain.c:76: attDeviceName[5] ='n';
	mov	dptr,#(_attDeviceName + 0x0005)
	mov	a,#0x6E
	movx	@dptr,a
;	../CodeGeneratorMain.c:87: buf[0] = GGS_SetParameter( GGS_DEVICE_NAME_ATT, GAP_DEVICE_NAME_LEN, attDeviceName );
	mov	a,#_attDeviceName
	push	acc
	mov	a,#(_attDeviceName >> 8)
	push	acc
	mov	a,#0x15
	push	acc
	mov	dpl,#0x00
	lcall	_GGS_SetParameter
	mov	r7,dpl
	dec	sp
	dec	sp
	dec	sp
	...
	mov	a,r7
	movx	@dptr,a
;	../CodeGeneratorMain.c:89: osal_start_timerEx( simpleBLEPeripheral_TaskID, CODEGENERATOR_EVT_1, 500 );
	...
	add	a,#0xfa
	mov	sp,a
;	../CodeGeneratorMain.c:92: sdcc_main_return; /* return macro, which is same as assembly below */
	LJMP 0x0122 ; ?BRET_FF 
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
