 ...
 * @return  bStatus_t
 */
extern bStatus_t GGS_SetParameter( uint8 param, uint8 len, __xdata void *value );
 ...
 * @return  bStatus_t
 */
extern bStatus_t GGS_GetParameter( uint8 param, __xdata void *value );
 ...
 * @return  none
 */
extern void GGS_RegisterAppCBs( __xdata ggsAppCBs_t *appCallbacks );
