 ...
 */
extern bStatus_t Accel_RegisterAppCBs(__xdata accelCBs_t *appCallbacks );
 ...
 *          uint16 pointer).
 */
extern bStatus_t Accel_SetParameter( uint8 param, uint8 len, __xdata void *value );
 ...
 *          uint16 pointer).
 */
extern bStatus_t Accel_GetParameter( uint8 param, __xdata void *value );
