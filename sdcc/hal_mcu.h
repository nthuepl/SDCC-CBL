 ...
 * ------------------------------------------------------------------------------------------------
 */
#define HAL_ENABLE_INTERRUPTS()         st( IEN0_EA = 1; )
#define HAL_DISABLE_INTERRUPTS()        st( IEN0_EA = 0; )
#define HAL_INTERRUPTS_ARE_ENABLED()    (IEN0_EA)

typedef unsigned char halIntState_t;
#define HAL_ENTER_CRITICAL_SECTION(x)   st( x = IEN0_EA;  HAL_DISABLE_INTERRUPTS(); )
#define HAL_EXIT_CRITICAL_SECTION(x)    st( IEN0_EA = x; )
#define HAL_CRITICAL_STATEMENT(x)       st( halIntState_t _s; HAL_ENTER_CRITICAL_SECTION(_s); x; HAL_EXIT_CRITICAL_SECTION(_s); )
   ...
   */
  #define HAL_ENTER_ISR()               { halIntState_t _isrIntState = IEN0_EA; HAL_ENABLE_INTERRUPTS();
  #define HAL_EXIT_ISR()                  IEN0_EA = _isrIntState; }
#else
