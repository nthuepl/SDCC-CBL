 ...
 */
   ...
   */
  extern bStatus_t GAP_SetAdvToken(__xdata  gapAdvDataToken_t *pToken );
   ...
   */
  extern __xdata gapAdvDataToken_t *GAP_RemoveAdvToken( uint8 adType );
 ...
 /**
   ...
   */
  extern bStatus_t GAP_ConfigDeviceAddr( uint8 addrType, __xdata uint8 *pStaticAddr );
 ...
 */
   ...
   */
  extern bStatus_t GAP_DeviceDiscoveryRequest(__xdata gapDevDiscReq_t *pParams );
   ...
   */
  extern bStatus_t GAP_MakeDiscoverable( uint8 taskID, __xdata gapAdvertisingParams_t *pParams );
   ...
   */
  extern bStatus_t GAP_ResolvePrivateAddr(__xdata uint8 *pIRK, __xdata uint8 *pAddr );
 ...
 */
   ...
   */
  extern bStatus_t GAP_EstablishLinkReq(__xdata gapEstLinkReq_t *pParams );
   ...
   */
  extern bStatus_t GAP_UpdateLinkParamReq(__xdata gapUpdateLinkParamReq_t *pParams );
 ...
 */
   ...
   */
  extern bStatus_t GAP_Authenticate(__xdata gapAuthParams_t *pParams,
   ...
   */
  extern bStatus_t GAP_PasskeyUpdate(__xdata uint8 *pPasskey, uint16 connectionHandle );
   ...
   *              FAILURE: not workable.<BR>
   */
  extern bStatus_t GAP_Signable( uint16 connectionHandle, uint8 authenticated, __xdata smSigningInfo_t *pParams );
 ...
 */
   ...
   * @return      none
   */
  extern void GAP_SecParamsInit(__xdata uint8 *pIRK, __xdata uint8 *pSRK, __xdata uint32 *pSignCounter );
