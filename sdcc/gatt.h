...
typedef struct
{
  ...
  __xdata uint8 *pValue; //!< Part of the value of the attribute to be written (must be allocated)
...
typedef struct
{
  ...
  __xdata attPrepareWriteReq_t *pReqs; //!< Arrary of Prepare Write Requests (must be allocated)
 ...
 */
extern bStatus_t GATT_PrepareWriteReq( uint16 connHandle, __xdata attPrepareWriteReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_ExecuteWriteReq( uint16 connHandle, __xdata attExecuteWriteReq_t *pReq, uint8 taskId );
 ...
 *          bleMemAllocError: Memory allocation error occurred.<BR>
 */
extern bStatus_t GATT_RegisterService( __xdata gattService_t *pService );
 ...
 */
extern bStatus_t GATT_DeregisterService( uint16 handle, __xdata gattService_t *pService );
 ...
 *          ATT_ERR_INSUFFICIENT_ENCRYPT: Attribute requires encryption.<BR>
 */
extern bStatus_t GATT_VerifyWritePermissions( uint16 connHandle, uint8 permissions, __xdata attWriteReq_t *pReq );
 ...
 */
extern __xdata gattAttribute_t *GATT_FindHandleUUID( uint16 startHandle, uint16 endHandle, const __xdata uint8 *pUUID,
                                             uint16 len, __xdata uint16 *pHandle );
/**
 ...
 * @return  Pointer to attribute record. NULL, otherwise.
 */
extern __xdata gattAttribute_t *GATT_FindHandle( uint16 handle, __xdata uint16 *pHandle );
 ...
 */
extern __xdata gattAttribute_t *GATT_FindNextAttr( __xdata gattAttribute_t *pAttr, uint16 endHandle,
                                           uint16 service, __xdata uint16 *pLastHandle );
/**
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_Indication( uint16 connHandle, __xdata attHandleValueInd_t *pInd, 
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_Notification( uint16 connHandle, __xdata attHandleValueNoti_t *pNoti,
                                    uint8 authenticated );
/**
 * @}
 */
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_ExchangeMTU( uint16 connHandle, __xdata attExchangeMTUReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_DiscPrimaryServiceByUUID( uint16 connHandle, __xdata uint8 *pValue,
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_DiscCharsByUUID( uint16 connHandle, __xdata attReadByTypeReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_ReadCharValue( uint16 connHandle, __xdata attReadReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_ReadUsingCharUUID( uint16 connHandle, __xdata attReadByTypeReq_t *pReq, uint8 taskId );
/**
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_ReadLongCharValue( uint16 connHandle, __xdata attReadBlobReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_ReadMultiCharValues( uint16 connHandle, __xdata attReadMultiReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_WriteNoRsp( uint16 connHandle, __xdata attWriteReq_t *pReq );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_SignedWriteNoRsp( uint16 connHandle, __xdata attWriteReq_t *pReq );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_WriteCharValue( uint16 connHandle, __xdata attWriteReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_WriteLongCharValue( uint16 connHandle, __xdata gattPrepareWriteReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_ReliableWrites( uint16 connHandle, __xdata attPrepareWriteReq_t *pReqs, 
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_ReadCharDesc( uint16 connHandle, __xdata attReadReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_ReadLongCharDesc( uint16 connHandle, __xdata attReadBlobReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_WriteCharDesc( uint16 connHandle, __xdata attWriteReq_t *pReq, uint8 taskId );
 ...
 *          bleTimeout: Previous transaction timed out.<BR>
 */
extern bStatus_t GATT_WriteLongCharDesc( uint16 connHandle, __xdata gattPrepareWriteReq_t *pReq, uint8 taskId );
