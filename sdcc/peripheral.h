 ...
 */
extern bStatus_t GAPRole_SetParameter( uint16 param, uint8 len, __xdata void *pValue );
 ...
 * @return      SUCCESS or INVALIDPARAMETER (invalid paramID)
 */
extern bStatus_t GAPRole_GetParameter( uint16 param, __xdata void *pValue );
 ...
 */
extern bStatus_t GAPRole_StartDevice( __xdata gapRolesCBs_t *pAppCallbacks );
