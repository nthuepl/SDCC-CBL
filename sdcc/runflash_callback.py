...
if __name__ == '__main__':
	...
	#print sys.argv[1][0:5]+"/CodeGeneratorJumpTable.bin"
	fh = open( sys.argv[1][0:6]+"/CodeGeneratorJumpTable.bin", 'rb' )
	jumptable = [i for i in bytearray(fh.read())]
	fh.close()
	...
	if UseSerialPort:
		...
		retVal = sendJumpTable(CG, jumptable)
		
		print "\nProgramming CallBacks Machine Code."
		retVal = sendCallBacks(CG, machineCode)
