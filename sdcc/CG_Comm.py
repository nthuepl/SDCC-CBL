...
class CG_Comm():
	...
	def analyse_packet(self, (packet, dictionary)):
		...
		if packet[6:10] == "0d06" and packet[12:14] == "04":
			...
			00 00 00 D0 07 00 
			"""
		elif packet[6:10] == '7f06' and packet[10:12] == '00' and packet[12:16] == '31fe':
			"""
			-Type		: 0x04 (Event)
			-EventCode	: 0xFF (HCI_LE_ExtEvent)
			...
			if self.getmini == True:
				print '> Max Connection Interval: ', int( packet[20:22]+packet[18:20], 16 )*1.25, 'ms'
			
			if self.getmini == False:
				print '> Mini Connection Interval: ', int( packet[20:22]+packet[18:20], 16 )*1.25, 'ms'
				self.getmini = True
